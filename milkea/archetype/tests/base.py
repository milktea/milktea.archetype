...
def setup_product():
    ...
    import milkea.archetype
    zcml.load_config('configure.zcml', milkea.archetype)
    ...
    ztc.installPackage('milkea.archetype')
...
setup_product()
ptc.setupPloneSite(products=['milkea.archetype'])
