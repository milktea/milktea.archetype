...
def setup_product():
    ...
    import milktea.archetype
    zcml.load_config('configure.zcml', milktea.archetype)
    ...
    ztc.installPackage('milktea.archetype')
...
setup_product()
ptc.setupPloneSite(products=['milktea.archetype'])
